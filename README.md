This project was made with Spring Boot, Spring Security, Spring Data JPA and MySQL. The main purpose of this project is to make an application which allows registering and logging in
